    ...
    render(){
        return (
            <div className = "container">
                ...
                <br></br>
                <br></br>
                <input required='true' type='text'className="form-control"value= {this.setState.username}onChange={this.onChangeUsername} placeholder='User Name'/>                   
                <br></br>
                <br></br>
                ...
                <br></br>
                <br></br>
                <input required='true'  className="form-control"  value= {this.setState.phone} onChange={this.onChangePhone} placeholder='Phone Number' />
                <br></br>
                <br></br>
                <label > Address </label>
                <br></br>
